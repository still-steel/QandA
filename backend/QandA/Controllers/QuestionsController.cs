...
namespace QandA.Controllers
{
	...
	public class QuestionsController : ControllerBase
	{
		...
		[HttpGet]
		public async Task<IEnumerable<QuestionGetManyResponse>> GetQuestions(string search, bool includeAnswers, int page = 1, int size = 20)
		{
			...
			{
				return await _dataRepository.GetQuestionsBySearchWithPaging(search, page, size);
			}
		}
		...
		{
			var questionExists = await _dataRepository.QuestionsExists(answerPostRequest.QuestionId.Value);
